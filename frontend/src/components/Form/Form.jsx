...
function Form() {
    ...
    <FormStyled onSubmit={handleSubmit}>
        ...
        <div className='input-control'>
            <DatePicker id='date' selected={date} placeholderText='Enter A Date' dateFormat="dd/MM/yyyy" onChange={(date) =>{
...
const FormStyled=styled.form`
    ...
    .submit-btn{
        button{
            color: rgba(9, 161, 68, 0.68);
            box-shadow: 0px 1px 15px rgba(0, 0, 0, 0.06);
            &:hover{
                background: rgb(12,34,90) !important;
            }
        }
    }
`;
