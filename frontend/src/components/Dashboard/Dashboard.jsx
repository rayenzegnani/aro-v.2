        ...
        <div className="p-4 md:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100">Financial Dashboard</h1>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow border border-gray-100 dark:border-gray-700">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="flex justify-between items-center bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-md">
                                        <span className="text-green-600 dark:text-green-400 font-medium">
                                            DT {incomes.length > 0 ? Math.min(...incomes.map(item => item.amount)) : 0}
                                        </span>
                                        <div className="flex-1 mx-2 h-1 bg-green-100 dark:bg-green-900/30 rounded-full overflow-hidden">
                                            <div 
                                                className="h-full bg-green-500" 
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between items-center bg-red-50 dark:bg-red-900/20 px-3 py-2 rounded-md">
                                        <span className="text-red-600 dark:text-red-400 font-medium">
                                            DT {expenses.length > 0 ? Math.min(...expenses.map(item => item.amount)) : 0}
                                        </span>
